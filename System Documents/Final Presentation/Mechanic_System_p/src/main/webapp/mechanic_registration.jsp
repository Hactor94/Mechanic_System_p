...
<div class="wrapper">
			<div class="inner">
				...
				<form action="/mechanic_registration" method="post" id="registration_form">
					...
					<div class="form-wrapper"> 
						<input type="text" placeholder="staff number" name="stuff_number" id="stuff_number" class="form-control">
						<i class="zmdi zmdi-account"></i>
					</div>
					<div class="form-wrapper">
						<input type="date" placeholder="Date Of Birth" name="date_of_birth" id="date_of_birth" class="form-control">
		...
		$("#email_error_message").hide();
         ...
         $("#registration_form").submit(function() {
            ...
            if (error_fname === false && error_lname === false && error_stuff_number === false && error_email === false && 
            		...
            		&& error_gender === false && error_terms === false) {
