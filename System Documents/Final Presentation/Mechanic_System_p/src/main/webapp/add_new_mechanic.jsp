          ...
          <div class="row">
            ...
            <div class="col-md-8 grid-margin">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Add New Mechanic </h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <p style="color:red; font-size: 13px;"> ${ message } </p>
                  <form action="/add_new_mechanic" id="new_mechanic_form">
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label> Company </label>
                        <input type="text" class="form-control" disabled="" name="company_name" id="company_name" value="Car-Repair-Shop Inc.">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Staff Number" name="stuff_number" id="stuff_number">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
            ...
            <div class="col-md-4 grid-margin">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> New Mechanic </h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                	<c:forEach items="${ mechanic_list }" var="mechanic">
                        <div class="d-flex py-2 border-bottom">
                          ...
                          <div class="wrapper ml-2">
                            <p class="mb-n1 font-weight-semibold"> ${ mechanic.fname } ${ mechanic.lname } </p>
                            <small>${ mechanic.stuff_number }</small>
                          </div>
