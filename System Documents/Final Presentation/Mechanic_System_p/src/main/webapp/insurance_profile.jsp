            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <p style="color:red; font-size: 13px;"> ${ message } </p>
                  <form action="/edit_insurance_profile" method="post" id="insurance_profile">
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label> Company </label>
                        <input type="text" class="form-control" name="company_name" id="company_name" value="${ insurance_user.company_name }">
                      </div>
                    </div>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label> Registration </label>
                        <input type="text" class="form-control" placeholder="Reg Number" name="reg_number" id="reg_number" value="${ insurance_user.reg_number }" disabled>
                        <input type="hidden" class="form-control" placeholder="Reg Number" name="reg_number" id="reg_number" value="${ insurance_user.reg_number }">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1"> Username </label>
                        <input type="text" class="form-control" placeholder="admin name" name="admin_name" id="username" value="${ insurance_user.admin_name }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Phone Number" name="phone" id="phone" value="${ insurance_user.phone }">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label> Email Address </label>
                        <input type="email" class="form-control" placeholder="Last Name" name="email" id="email" value="${ insurance_user.email }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Address</label>
                        <input type="text" class="form-control" placeholder="Company Address" name="address" id="address" value="${ insurance_user.address }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>City</label>
                        <input type="text" class="form-control" placeholder="City" name="city" id="city" value="${ insurance_user.city }">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Country</label>
                        <input type="text" class="form-control" placeholder="Country" name="country" id="state" value="${ insurance_user.country }">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>Postal Code</label>
                        <input type="text" class="form-control" name="zip_code" placeholder="zip_code" id="zip_code" value="${ insurance_user.zip_code }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
...
<script>
      $(function() {
         ...
         $("#insurance_profile").submit(function() {
        	 error_company_name = false;
             error_username = false;
             error_reg_number = false;
             error_phone = false;
            ...
            if (error_company_name === false && error_username === false && error_reg_number === false && error_phone === false && 
            		error_email === false && error_address === false && error_city === false && error_state === false && 
            		error_zip_code === false) {
