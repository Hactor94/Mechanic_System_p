                     ...
                     <table class="table" id="table_bookings">
                       ...
                       <tbody>
                         <tr>
                           ...
                           <td>${ payment.car.booking.fname } ${ payment.car.booking.lname }</td>
                           <td>${ payment.car.booking.brand } ${ payment.car.booking.model } ${ payment.car.booking.car_year }</td>
                           <td>${ payment.car.total_cost }</td>
                           <td>${ payment.car.mechanic.fname } ${ payment.car.mechanic.lname }</td>
                           <td>${ payment.car.insurance.company_name }</td>
						   <td>
	                       </td>
                         </tr>
                       </tbody>
