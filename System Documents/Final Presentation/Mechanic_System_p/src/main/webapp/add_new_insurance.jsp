          ...
          <div class="row">
            ...
            <div class="col-md-8 grid-margin">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Add Insurance Company </h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                <p style="color:red; font-size: 13px;"> ${ message } </p>
                  <form action="/add_new_insurance" id="new_insurance_form">
                  <div class="row">
                    ...
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Registation Number" name="reg_number" id="reg_number">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label> Username </label>
                        <input type="text" class="form-control" placeholder="Username" name="admin_name" id="username">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label> Country </label>
                        <input type="text" class="form-control" placeholder="Country" name="country" id="state">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
            ...
            <div class="col-md-4 grid-margin">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> New Companies </h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                	<c:forEach items="${ insurance_list }" var="insurance">
                        <div class="d-flex py-2 border-bottom">
                          ...
                          <div class="wrapper ml-2">
                            <p class="mb-n1 font-weight-semibold"> ${ insurance.company_name } </p>
                            <small> ${ insurance.reg_number } </small>
                          </div>
		...
		$("#email_error_message").hide();
         ...
         function check_company_name() {
            ...
            if (pattern.test(company_name) && company_name !=='') {
               $("#company_name").css("border-bottom","none");
         ...
         function check_reg_number() {
             ...
             if (pattern.test(reg_number) && reg_number !=='') {
                $("#reg_number").css("border-bottom","none");
         ...
         $("#new_insurance_form").submit(function() {
        	 error_company_name = false;
             error_username = false;
             error_reg_number = false;
             error_phone = false;
            ...
            if (error_company_name === false && error_username === false && error_reg_number === false && error_phone === false && 
            		error_email === false && error_state === false) {
            	alert("Click 'Ok' to add Insurance");
               return true;
            } else {
