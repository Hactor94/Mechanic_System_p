	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method="post" action="${contextPath}/login" class="login100-form validate-form" id="login_form">
					...
					<div class="container-login100-form-btn">
						<p> Or you new in this system? <a href="registration.jsp"> Register </a></p>
					</div>
					<div class="container-login100-form-btn">
