...
public class Clerk {
	...
	@NotNull private String roles = "CLERK";
	@NotNull private String permissions = "CLERK";
	...
	public Clerk(int StaffNumber, String fname, String lname, Date dob, String phone, String email, String gender, 
	...
	public String toString() {
		return "Clerk [StaffNumber=" + StaffNumber + ", fname=" + fname + ", lname=" + lname + ", dob=" + dob
