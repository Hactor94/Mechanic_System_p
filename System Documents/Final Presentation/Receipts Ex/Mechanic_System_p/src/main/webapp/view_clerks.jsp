            ...
            <div class="col-md-12 grid-margin">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Clerks </h6>
                </div>
                <!-- Card Body -->
                ...
                <div class="card-body" id="new_booking">
                  ...
                  <div class="table-responsive">
                     <table class="table" id="table_bookings">
                       ...
                       <tbody>
                         <tr>
                           <td>${ clerk.staffNumber }</td>
                           <td>${ clerk.fname } ${ clerk.lname }</td>
                           <td>${ clerk.phone }</td>
                           <td>${ clerk.email }</td>
                           <td>${ clerk.roles }</td>
                           <td>
                           <c:if test="${doctor_user.roles == 'ADMIN, DOCTOR'}">
                           		<form action="/delete_clerk">
								<div class="dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
										<input type="hidden" name="staffNumber" id="booking_id" value="${ clerk.staffNumber }">
										<button class="dropdown-item" type="submit"> Delete Clerk </button>
										<c:choose>
											<c:when test="${ clerk.active == 1 }">
												<button class="dropdown-item" type="submit" formaction="/mute_clerk"> Mute Clerk </button>
											</c:when>
											<c:when test="${ clerk.active == 0 }">
												<button class="dropdown-item" type="submit" formaction="/mute_clerk"> Make Active </button>
											</c:when>
										</c:choose>
									</div>
								</div>
