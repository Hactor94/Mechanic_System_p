          ...
          <div class="row">
            ...
            <div class="col-md-8 grid-margin">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Add New Clerk </h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <p style="color:red; font-size: 13px;"> ${ message } </p>
                  <form action="/add_new_clerk" id="new_mechanic_form">
                  <div class="row">
            ...
            <div class="col-md-4 grid-margin">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> New Clerk(s) </h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                	<c:forEach items="${ clerk_list }" var="clerk">
                        <div class="d-flex py-2 border-bottom">
                          ...
                          <div class="wrapper ml-2">
                            <p class="mb-n1 font-weight-semibold"> ${ clerk.fname } ${ clerk.lname } </p>
                            <small>${ clerk.staffNumber }</small>
                          </div>
