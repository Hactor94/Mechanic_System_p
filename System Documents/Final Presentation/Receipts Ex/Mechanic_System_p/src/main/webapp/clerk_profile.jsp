	...
	<!-- partial:partials/_sidebar.html -->
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <c:if test="${ mechanic_user.roles == 'ADMIN, DOCTOR'}">
            <li class="nav-item">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> ${ clerk_user.fname } ${ clerk_user.lname } </span>
          ...
          <!-- Pie Chart -->
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <a href="/user_profile">
                    ...
                    <h5 class="title text-center"> ${ clerk_user.fname } ${ clerk_user.lname } </h5>
                  </a>
                  <p class="description text-center">
                    ${ clerk_user.staffNumber }
                  </p>
                </div>
                <p class="description text-center">
                </p>
              ...
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Other Clerks </h6>
                </div> 
                <!-- Card Body -->
                <div class="card-body">
                        <ul class="list-unstyled team-members">
                <c:forEach items="${clerk_list}" var = "clerk">
                  <li>
                    <div class="row mb-2">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <p style="color:red; font-size: 13px;"> ${ message } </p>
                  <form action="/edit_clerk_profile" method="post" id="mechanic_profile">
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label> Company </label>
                        <input type="text" class="form-control" disabled placeholder="Company" name="company_name" value="Health Center Inc.">
                      </div>
                    </div>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label> Staff Number </label>
                        <input type="hidden" class="form-control" placeholder="Staff Number" name="staffNumber" id="stuff_number" value="${ clerk_user.staffNumber }">
                        <input type="text" class="form-control" disabled placeholder="Staff Number" name="staffNumber" id="stuff_number" value="${ clerk_user.staffNumber }">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" class="form-control" placeholder="Email" name="email" id="email" value="${ clerk_user.email }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="First Name" name="fname" id ="fname" value="${ clerk_user.fname }">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Last Name</label>
                        <input type="text" class="form-control" placeholder="Last Name" name="lname" id="lname" value="${ clerk_user.lname }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" placeholder="Date Of Birth " name="dob" id="date_of_birth" value="${ clerk_user.dob }">
                      </div>
                    </div>
                    <div class="col-md-4 px-5">
                        <label> Gender
							<select class="form-control" name="gender" id="gender">
								<option value="${ clerk_user.gender }" selected>${ clerk_user.gender }</option>
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Phone Number" name="phone" id="phone" value="${ clerk_user.phone }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <input type="hidden" name="password" id="password" value="${ clerk_user.password }">
                  <input type="hidden" name="roles" id="roles" value="${ clerk_user.roles }">
                  <input type="hidden" name="permissions" id="permissions" value="${ clerk_user.permissions }">
                  <input type="hidden" name="active" id="active" value="${ clerk_user.active }">
                  <input type="hidden" name="terms" id="terms" value="${ clerk_user.terms }">
                  <div class="row">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span> Clerk Console Footer </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
