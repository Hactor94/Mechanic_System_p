              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body" id="new_booking">
                  <div class="d-flex justify-content-between">
                     <h2 class="text-xs font-weight-bold text-primary text-uppercase mb-2"> New Patients </h2>
                  </div>
                  ...
                  <div class="table-responsive">
                     <table class="table" id="table_consideration">
                       ...
                       <c:forEach items="${under_con}" var = "considered">
                       <tbody>
                         <tr>
                  ...
                  <div class="d-flex justify-content-between">
                     <h2 class="text-xs font-weight-bold text-warning text-uppercase mb-2"> Collect Medication </h2>
                  </div>
                  <div class="table-responsive">
                     <table class="table" id="table_ready">
                       ...
                       <c:forEach items="${ready_for_collect}" var = "collect">
                       <tbody>
                         <tr>
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					...
					<div class="dropdown no-arrow">
						...
						<input type="hidden" name="appointmentId" id="appointmentId" value="${ value.appointmentId }">
							...
							<c:if test="${ value.appointmentStatus == 'Pending Payment'}">
								<button class="dropdown-item" type="submit"> Confirm Payment </button>
							</c:if>
							<c:if test="${ value.appointmentStatus == 'Collect Medication'}">
								<button class="dropdown-item" type="submit" formaction="/medication_collected"> Medication Collected </button>
							</c:if>
						</div>
					</div>
					</form>
				...
				<!-- Card Body -->
					<div class="card-body">
						...
						<div class="wrapper">
                          ...
                          <div class="d-flex w-100 pt-2">
                            <p class="mb-0 font-weight-semibold"> Report </p>
                            <div class="wrapper ml-auto d-flex align-items-center">
                            <form action="/files" method="get">
                            <input type="hidden" name="file" id="file" value="${ value.report }">
                              <button type="submit" class="btn btn-light btn-fw text-right">
								${ value.report } <i class="fa fa-download text-right"></i>
							  </button>
							</form>
                            </div>
                          </div>
