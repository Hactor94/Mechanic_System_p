	...
	<!-- partial:partials/_sidebar.html -->
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item nav-category mt-4"> Main Menu </li>
            <li class="nav-item">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
              ...
              <div class="card border-left-primary shadow h-100 py-2" id="b_hover">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-2"> New Appointments </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"> ${ total_new_appointments } </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              ...
              <div class="card border-left-success shadow h-100 py-2" id="u_hover">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-2"> Consideration </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"> ${ total_consideration } </div>
                    </div>
                    <div class="col-auto">
                      <i class="fa fa-plus-circle fa-2x text-gray-300"></i>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              ...
              <div class="card border-left-warning shadow h-100 py-2" id="r_hover">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-2"> Collect Medication </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"> ${ total_collections } </div>
                    </div>
                    <div class="col-auto">
                      <i class="fa fa-plus-circle fa-2x text-gray-300"></i>
                    </div>
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body" id="new_booking">
                  <div class="d-flex justify-content-between">
                     <h2 class="text-xs font-weight-bold text-primary text-uppercase mb-2"> New Appointment </h2>
                  </div>
                  <div class="table-responsive">
                     <table class="table" id="table_bookings">
                       ...
                       <c:forEach items="${new_appointments}" var = "appointment">
                       <tbody>
                         <tr>
                  ...
                  <div class="d-flex justify-content-between">
                     <h2 class="text-xs font-weight-bold text-success text-uppercase mb-2"> Consideration </h2>
                  </div>
                  <div class="table-responsive">
                     <table class="table" id="table_consideration">
                       ...
                       <c:forEach items="${consideration}" var = "considered">
                       <tbody>
                         <tr>
                           <td>${ considered.appointmentId }</td>
                           <td>${ considered.patient.fname } ${ considered.patient.lname }</td>
                           <td>${ considered.patient.phone }</td>
                           <td>${ considered.patient.email }</td>
                           <td>${ considered.patient.dob }</td>
                         </tr>
                       </tbody>
                       </c:forEach>
                     </table>
                  ...
                  <div class="table-responsive">
                     <table class="table" id="table_pending">
                       ...
                       <c:forEach items="${pending_payment}" var = "payment">
                       <tbody>
                         <tr>
                  ...
                  <div class="table-responsive">
                     <table class="table" id="table_ready">
                       ...
                       <c:forEach items="${ready_to_collect}" var = "collect">
                       <tbody>
                         <tr>
                           <td>${ collect.appointmentId }</td>
                           <td>${ collect.patient.fname } ${ collect.patient.lname }</td>
                           <td>${ collect.patient.phone } </td>
                           <td>${ collect.patient.email }</td>
                           <td>${ collect.patient.dob }</td>
                         </tr>
                       </tbody>
                       </c:forEach>
                     </table>
            ...
            <c:forEach items="${appointment}" var = "value">
            <div id="appointment${ value.appointmentId }">
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary"> Appointment Overview </h6>
					<form action="/patient_arrived">
					<div class="dropdown no-arrow">
						<a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
						</a>
						<input type="hidden" name="appointmentId" id="appointmentId" value="${ value.appointmentId }">
						<div class="dropdown-menu" aria-labelledby="userDropdown">
							<div class="dropdown-header text-center"> Status Action(s) </div>
							<c:if test="${ value.appointmentStatus == 'New Appointment'}">
								<button class="dropdown-item" type="submit"> Patient Arrived </button>
							</c:if>
							<c:if test="${ value.appointmentStatus == 'Consideration'}">
								<button class="dropdown-item" type="submit" formaction="/send_report"> Send Patient Report </button>
							</c:if>
							<c:if test="${ value.appointmentStatus == 'Consideration'}">
							<div class="dropdown-divider"></div>
							<button class="dropdown-item" type="submit" formaction="/remove_patient"> Remove Patient </button>
							</c:if>
						</div>
					</div>
					</form>
				...
				<!-- Card Body -->
					<div class="card-body">
						<h4 class="card-title text-center"> Dr ${ value.patient.doctor } </h4>
						<img class="img-profile mx-auto d-block" src="assets/img/General.jfif" alt="alt">
						<div class="wrapper">
                          <div class="d-flex w-100 pt-2 mt-4">
                            <p class="mb-0 font-weight-semibold"> Status </p>
                            <div class="wrapper ml-auto d-flex align-items-center">
                              <p class="mb-0"> ${ value.appointmentStatus } </p>
                            </div>
                          </div>
                          <div class="d-flex w-100 pt-2">
                            <p class="mb-0 font-weight-semibold"> Date </p>
                            <div class="wrapper ml-auto d-flex align-items-center">
                              <p class="mb-0"> ${ value.patient.appointmentDate } </p>
                            </div>
                          </div>
                          <div class="d-flex w-100 pt-2">
                            <p class="mb-0 font-weight-semibold"> Total Cost </p>
                            <div class="wrapper ml-auto d-flex align-items-center">
                              <p class="mb-0"> ${ value.total_cost } </p>
                            </div>
                          </div>
                          <div class="d-flex w-100 pt-2">
                            <p class="mb-0 font-weight-semibold"> Clerk </p>
                            <div class="wrapper ml-auto d-flex align-items-center">
                              <p class="mb-0"> ${ value.clerk.fname }</p>
                            </div>
                          </div>
                        </div>	
						</div>
...
<script>
	$(document).ready(function(){
		$("#under_consideration").hide(); $("#pending_payment").hide(); $("#ready_to_collect").hide(); $("[id*='appointment']").hide();
		$("[id*='address']").hide();
