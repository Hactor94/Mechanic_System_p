	...
	<!-- partial:partials/_sidebar.html -->
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <c:if test="${ doctor_user.roles == 'ADMIN, DOCTOR'}">
            <li class="nav-item">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> ${ doctor_user.fname } ${ doctor_user.lname } </span>
          ...
          <!-- Pie Chart -->
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <a href="/user_profile">
                    ...
                    <h5 class="title text-center"> ${ doctor_user.fname } ${ doctor_user.lname } </h5>
                  </a>
                  <p class="description text-center">
                    ${ doctor_user.staffNumber }
                  </p>
                </div>
                <p class="description text-center">
                </p>
              ...
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Other Doctors </h6>
                </div> 
                <!-- Card Body -->
                <div class="card-body">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <p style="color:red; font-size: 13px;"> ${ message } </p>
                  <form action="edit_doctor_profile" method="post" id="mechanic_profile">
                  <div class="row">
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" placeholder="Staff Number" name="staffNumber" id="stuff_number" value="${ doctor_user.staffNumber }">
                        <input type="text" class="form-control" disabled placeholder="Staff Number" name="staffNumber" id="stuff_number" value="${ doctor_user.staffNumber }">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" class="form-control" placeholder="Email" name="email" id="email" value="${ doctor_user.email }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="First Name" name="fname" id ="fname" value="${ doctor_user.fname }">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Last Name</label>
                        <input type="text" class="form-control" placeholder="Last Name" name="lname" id="lname" value="${ doctor_user.lname }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" placeholder="Date Of Birth " name="dob" id="date_of_birth" value="${ doctor_user.dob }">
                      </div>
                    </div>
                    <div class="col-md-4 px-5">
                        <label> Gender
							<select class="form-control" name="gender" id="gender">
								<option value="${ doctor_user.gender }" selected>${ doctor_user.gender }</option>
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Phone Number" name="phone" id="phone" value="${ doctor_user.phone }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <input type="hidden" name="password" id="password" value="${ doctor_user.password }">
                  <input type="hidden" name="roles" id="roles" value="${ doctor_user.roles }">
                  <input type="hidden" name="permissions" id="permissions" value="${ doctor_user.permissions }">
                  <input type="hidden" name="active" id="active" value="${ doctor_user.active }">
                  <input type="hidden" name="terms" id="terms" value="${ doctor_user.terms }">
                  <div class="row">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span> Doctor Console Footer </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
