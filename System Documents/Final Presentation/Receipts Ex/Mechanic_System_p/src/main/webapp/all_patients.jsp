            ...
            <div class="col-md-12 grid-margin">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> All Patient Bookings </h6>
                </div>
                <!-- Card Body -->
                     ...
                     <table class="table" id="table_bookings">
                       ...
                       <tbody>
                         <tr>
						   ...
						   <td>
						   <c:choose>
	                       <c:when test="${patient.appointment[0].appointmentStatus == null}">
	                         <form action="/send_email">
								<div class="dropdown">
									<button class="btn btn-primary icon-btn" type="button" id="dropdownMenuIconButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<i class="fa fa-ellipsis-v fa-2x text-gray-300"></i>
									</button>
									<div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
										<input type="hidden" name="appointmentStatus" id="appointmentStatus" value="New Appointment">
										<input type="hidden" name="patientId" id="patientId" value="${ patient.patientId }">
										<c:if test="${ user.roles == 'CLERK'}">
										<button class="dropdown-item" type="submit"> Send Email </button>
										</c:if>
										<div class="dropdown-divider"></div>
										<button class="dropdown-item" type="submit" formaction="/edit_appointment"> Edit Patient Details </button>
									</div>
								</div>
							  </form>
	                        </c:when>
	                        <c:when test="${patient.appointment[0].appointmentStatus != null}">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
										...
										<button class="dropdown-item" type="submit"> Edit Patient Details </button>
									</div>
								</div>
							  </form>
	                        </c:when>
