                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Mechanic Name" name="fname" value="${ car.mechanic.fname }">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1"> Insurance </label>
                        <input type="text" class="form-control" placeholder="Insurance: it can be null" name="company_name" value="${ car.insurance.company_name }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="First Name" name="fname" value="${ car.booking.fname }">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Last Name</label>
                        <input type="text" class="form-control" placeholder="Last Name" name="lname" value="${ car.booking.lname }">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label> Car </label>
                        <input type="text" class="form-control" placeholder="Car Brand" name="brand" value="${ car.booking.brand }">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label> Service Type </label>
                        <input type="text" class="form-control" placeholder="Service Type" name="service_type" value="${ car.booking.service_type }">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label> Total Cost </label>
                        <input type="text" class="form-control" placeholder="Total Cost" name="total_cost" value="${ car.total_cost }">
                      </div>
                    </div>
                  </div>
                  <br>
