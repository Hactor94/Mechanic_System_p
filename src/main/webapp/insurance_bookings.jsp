                ...
                <div class="card-body" id="new_booking">
                  ...
                  <div class="table-responsive">
                     <table class="table" id="table_bookings">
                       ...
                       <tbody>
                         <tr>
                           <td>${ booking.booking.booking_id }</td>
                           <td>${ booking.booking.fname } ${ booking.booking.lname }</td>
                           <td>0${ booking.booking.phone }</td>
                           <td>${ booking.booking.email }</td>
                           <td>${ booking.booking.address_line1 }, ${ booking.booking.city }, ${ booking.booking.state }, ${ booking.booking.zip }</td>
                           <td> 
                              <form action="/edit_appointment"">
								<div class="dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
										<input type="hidden" name="booking" id="booking" value="${ booking.booking.booking_id }">
