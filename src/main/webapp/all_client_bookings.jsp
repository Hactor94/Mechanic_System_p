            ...
            <div class="col-md-12 grid-margin">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> All Client Bookings </h6>
                </div>
                <!-- Card Body -->
                     ...
                     <table class="table" id="table_bookings">
                       ...
                       <tbody>
                         <tr>
                           ...
                           <td>${ booking.email }</td>
                           <td>${ booking.address_line1 }, ${ booking.city }, ${ booking.state }, ${ booking.zip }</td>
						   <td>
						   <c:choose>
	                       <c:when test="${booking.cars[0].carStatus == null}">
	                         <form action="/add_car">
								<div class="dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
										...
										<input type="hidden" name="carStatus" id="carStatus" value="New Car">
										<input type="hidden" name="booking_id" id="booking_id" value="${ booking.booking_id }">
										<input type="hidden" name="insurance" id="insurance" value="${ booking.insurance }">
										<button class="dropdown-item" type="submit"> Accept Booking </button>
										<button class="dropdown-item" type="submit" formaction="/delete"> Reject Booking </button>
										<div class="dropdown-divider"></div>
										<button class="dropdown-item" type="submit" formaction="/edit_appointment"> Edit Client Details </button>
									</div>
								</div>
							  </form>
	                        </c:when>
	                        <c:when test="${booking.cars[0].carStatus != null}">
								<form action="/edit_appointment"">
								<div class="dropdown">
									<button class="btn btn-primary icon-btn dropdown-toggle" type="button" id="dropdownMenuIconButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<i class="fas fa-2x text-gray-300"> Actions </i>
									</button>
									<div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
										<input type="hidden" name="booking" id="booking" value="${ booking.booking_id }">
										<button class="dropdown-item" type="submit"> Edit Client Details </button>
									</div>
								</div>
							  </form>
	                        </c:when>
