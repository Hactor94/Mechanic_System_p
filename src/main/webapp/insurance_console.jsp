                     ...
                     <table class="table" id="table_consideration">
                       ...
                       <tbody>
                         <tr>
                           ...
                           <td>0${ considered.booking.phone }</td>
                     ...
                     <table class="table" id="table_pending">
                       ...
                       <tbody>
                         <tr>
                           ...
                           <td>0${ considered.booking.phone }</td>
                           <td>${ considered.booking.email }</td>
                           <td id="address_pay_td">${ considered.booking.address_line1 }, ${ considered.booking.city }, ${ considered.booking.state }, ${ considered.booking.zip }</td>
                         </tr>
                       </tbody>
                       </c:forEach>
                     </table>
                  ...
                  <div class="table-responsive">
                     <table class="table" id="table_ready">
                       ...
                       <tbody>
                         <tr>
                           <td>${ collect.carId }</td>
                           <td>${ collect.fname } ${ collect.lname }</td>
                           <td>0${ collect.phone }</td>
                           <td>${ collect.email }</td>
                           <td id="address_ready_td">${ collect.address_line1 }, ${ collect.city }, ${ collect.state }, ${ collect.zip }</td>
                         </tr>
                       </tbody>
                       </c:forEach>
                     </table>
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					...
					<div class="dropdown no-arrow">
						...
						<div class="dropdown-menu" aria-labelledby="userDropdown">
							<div class="dropdown-header text-center"> Actions </div>
							<div class="dropdown-divider"></div>
							<c:if test="${ value.carStatus != 'Ready For Collection'}">
								<button class="dropdown-item" type="submit"> Send Payment Proof </button>
							</c:if>
						</div>
					</div>
					</form>
					...
					<div class="card-body">
						...
						<div class="wrapper">
                          ...
                          <div class="d-flex w-100 pt-2">
                            ...
                            <input type="hidden" name="report_url" id="report_url" value="${ value.report_url }">
                              <button type="submit" class="btn btn-light btn-fw">
